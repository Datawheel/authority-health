      ...
      <SectionColumns>
        ...
        <article>
          ...
          {isZipLevelDataAvailable ? <p>In {topMostRaceData.Year}, {formatPercentage(topZipLevelData[topZipLevelData.RaceType])} of the population in {`zip ${topZipLevelData.Geography}`} were {lowerCaseRaceName(formatRaceNames(topZipLevelData.RaceType))} residents who visited health centers more than any other race/ethnicity group, compared to {formatPercentage(topMostRaceData[topMostRaceData.RaceType])} {lowerCaseRaceName(formatRaceNames(topMostRaceData.RaceType))} residents in Wayne County.</p> 
            : <p>In {topMostRaceData.Year}, {lowerCaseRaceName(formatRaceNames(topMostRaceData.RaceType))} residents of Wayne County visited health centers more than any other race/ethnicity group ({formatPercentage(topMostRaceData[topMostRaceData.RaceType])} of the population). This is followed by {lowerCaseRaceName(formatRaceNames(topSecondRaceData.RaceType))} residents ({formatPercentage(topSecondRaceData[topSecondRaceData.RaceType])}) and then {lowerCaseRaceName(formatRaceNames(topThirdRaceData.RaceType))} residents ({formatPercentage(topThirdRaceData[topThirdRaceData.RaceType])}).</p>}
