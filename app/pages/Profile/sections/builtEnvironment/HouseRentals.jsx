...
HouseRentals.need = [
  ...
  fetchData("rentersByIncomePercentage", "https://gila-cliff.datausa.io/api/data?measures=Renters%20by%20Income%20Percentage&drilldowns=Household%20Income&Year=all&Geography=<id>", d => d.data)
];
