...
Rentals.need = [
  ...
  fetchData("rentersByIncomePercentage", "https://olympic.datausa.io/api/data?measures=Renters by Income Percentage&drilldowns=Household Income&Year=all&Geography=<id>", d => d.data)
];
