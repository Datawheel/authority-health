    ...
    return (
      <SectionColumns>
        ...
        <article>
          ...
          <p>In {topEmploymentStatus.Year}, {veteransEmploymentStatusAvailable ? formatPercentage(topEmploymentStatus.share) : "N/A"} of the veteran population in {topEmploymentStatus.Geography} were unemployed, {}
          while {veteransPovertyStatusAvailable ? formatPercentage(veteransPovertyStatus[0].share) : ""} were impoverished and {veteransDisabilityStatusAvailable ? formatPercentage(veteransDisabilityStatus[0].share) : "N/A"} were disabled.</p>
          ...
          {periodOfServiceAvailable ? <p>The chart here shows the percentages of veterans that served in the most common periods of service.</p> : ""}
